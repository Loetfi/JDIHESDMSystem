 ...
 <head>
    ...
    <!-- Page Title -->
    <title> JDIH - Kementerian Energi dan Sumber Daya Mineral | <?php echo @$title; ?> | <?php echo @$subtitle; ?></title>
    ...
    <div class="wrapper">
        ...
        <header>
            <div class="header-area">
                    ...
                    <div class="container"> 
                        <div class="col-xs-11 col-sm-11 col-md-5 logo">
                            ...
                            <a href="<?php echo site_url(); ?>">
                                <img src="http://project.awanesia.com/ppid_esdm/assets/front/new/images/logo-footer.png" alt="JDIH Logo"/>
                ...
                <?php if ($this->uri->segment(1)=='format') { ?>

                    <nav id="navbar" class="collapse navbar-collapse main-menu">
                        <div class="container">
                            <ul class="main-menu">

                                <li class="active"> <a href="http://localhost/projekan/jdih/index.php"> Beranda </a></li>
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Keputusan <i class="fa fa-chevron-down dropdown-toggle"> </i>  </a>
                                    <ul>
                                        <li><a href="#" >Keputusan Menteri</a></li>  
                                        <li><a href="#" >Keputusan Delegasi Menteri</a></li>
                                        <li><a href="#" >Keputusan Pejabat Pimipinan Tinggi Madya</a></li>
                                        <li><a href="#" >Keputusan Pejabat Pimipinan Tinggi Pratama</a></li>
                                        <li><a href="#" >Keputusan KPA/KPB Satuan Kerja Setjen KESDM</a></li>
                                        <li><a href="#" >Keputusan KPA/KPB Satuan Kerja PPBMN</a></li>
                                    </ul> 
                                </li>

                                <li>
                                    <a href="#" >Ins. Menteri</a>
                                </li>
                                <li>
                                    <a href="#" >S.Perintah</a>
                                </li>
                                ...
                                <li class="dropdown pull-right">
                                    <a href="#" class="" data-toggle="dropdown">Surat Edaran &nbsp;&nbsp; &nbsp; &nbsp;  <i class="fa fa-chevron-down dropdown-toggle"> </i>  </a>
                                    <ul>
                                        <li><a href="#"> Surat Edaran Menteri</a> </li>
                                        <li><a href="#"> Surat Edaran Delegasi Menteri</a> </li>
                                        <li><a href="#"> Surat Edaran Pejabat Pimpinan Tinggi Madya</a> </li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
