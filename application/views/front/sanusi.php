		...
		<div class="row">
			<div class="col-md-8" id="allButton" >
				...
				<div class="col-xs-3 col-sm-3 col-md-3">
					<a href="#"><img src="<?php echo base_url(); ?>/assets/logo/icon-rancangan-solid.png" width="100%"></a>
				</div>
				<div class="col-xs-3 col-sm-3 col-md-3">
					<a href="#"><img src="<?php echo base_url(); ?>/assets/logo/icon-telaah-solid.png" width="100%"></a>
				</div>
				<div class="col-xs-3 col-sm-3 col-md-3">
					<a href="#"><img src="<?php echo base_url(); ?>/assets/logo/icon-database-solid.png" width="100%"></a>
				</div>
				<div class="col-xs-3 col-sm-3 col-md-3">
