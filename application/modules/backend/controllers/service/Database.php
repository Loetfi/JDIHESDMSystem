...
class Database extends CI_Controller {
	...
	public function index($login_id)
	{
		...
		$this->load->model('service/database_model','lists');
		// $this->cabang_model->get_datatables();

		$table          = 'dokumen';
    	$column_order   = ['a.id_dokumen' , 'a.jenis_dokumen', 'a.nama_dokumen', 'b.sub_sector' , 'a.cdate']; //set column field database for datatable orderable
    	$column_search  = ['a.id_dokumen' , 'a.jenis_dokumen', 'a.nama_dokumen', 'b.sub_sector' , 'a.cdate'];
		...
		foreach ($list as $d) {
			...
			$row[] 	= '<b>'.strtoupper($d->sub_sector).'</b>';
