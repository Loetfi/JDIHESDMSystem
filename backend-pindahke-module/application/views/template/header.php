...
<head>
	...
	<link href="<?php echo base_url('asset/style.css') ?>" rel="stylesheet"></head>
	<body class="app">
		<div id="loader">
			<div class="spinner"/>
		</div>
			...
			<div class="page-container">
				<div class="header navbar">
					<div class="header-container">
						...
						<li class="pX-20 pY-15 ta-c bdT">
							<span>
								<a href="" class="c-grey-600 cH-blue fsz-sm td-n">View All Notifications <i class="ti-angle-right fsz-xs mL-10"/>
								</a>
							</span>
						</li>
					</ul>
				...
				<li class="notifications dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li class="pX-20 pY-15 ta-c bdT">
							<span>
								<a href="email.html" class="c-grey-600 cH-blue fsz-sm td-n">View All Email <i class="fs-xs ti-angle-right mL-10"/>
								</a>
							</span>
						</li>
					</ul>
						...
						<div class="layers">
							...
							<div class="layer bdT p-20 w-100">
								<div class="peers ai-c jc-c gapX-20">
									<div class="peer">
										<span class="fsz-def fw-600 mR-10 c-grey-800">10% <i class="fa fa-level-up c-green-500"/>
										</span>
										<small class="c-grey-500 fw-600">APPL</small>
									</div>
									<div class="peer fw-600">
										<span class="fsz-def fw-600 mR-10 c-grey-800">2% <i class="fa fa-level-down c-red-500"/>
										</span>
										<small class="c-grey-500 fw-600">Average</small>
									</div>
									<div class="peer fw-600">
										<span class="fsz-def fw-600 mR-10 c-grey-800">15% <i class="fa fa-level-up c-green-500"/>
										</span>
										<small class="c-grey-500 fw-600">Sales</small>
									</div>
									<div class="peer fw-600">
										<span class="fsz-def fw-600 mR-10 c-grey-800">8% <i class="fa fa-level-down c-red-500"/>
										</span>
...
<script type="text/javascript" src="<?php echo base_url('asset/vendor.js'); ?>"></script>
<script type="text/javascript" src="<?php echo base_url('asset/bundle.js'); ?>"></script>
</body>
</html>
